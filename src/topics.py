...
규칙:
- **일반 국민이 실제로 신청해서 받는 현금성 보조금·지원금 위주**(수당·바우처·급여·환급·감면 등,
  육아·청년·주거·에너지·취업·노후·의료 등 대중적 대상). 신청조건·대상·금액·기간·달라지는 점을 구체 질문형으로.
  예: '부모급여 인상 소급 적용', '에너지바우처 신청 자격', '근로장려금 반기 신청 조건'
- **제외(수급성·검색수요 낮음)**: 단속·처벌·수사·범죄·행정절차·데이터/통계 공개·기관 행사·홍보·연예.
  범죄피해구조금·불법사이트 처벌·빅데이터 공개 류는 '내가 받는 보조금'이 아니므로 뽑지 마라.
